...
class Salesforce extends Module
{
	...
	{
		Configuration::updateValue('SALESFORCE_LIVE_MODE', false);
	...
	{
		Configuration::deleteByName('SALESFORCE_LIVE_MODE');
	...
	protected function renderForm()
	{
		...
		$helper->submit_action = 'submitSalesforceModule';
			...
			'form' => array(
				...
				'input' => array(
					...
					array(
						...
						'name' => 'SALESFORCE_ACCOUNT_EMAIL',
						'label' => $this->l('Email'),
					),
					array(
						'type' => 'password',
						'name' => 'SALESFORCE_ACCOUNT_PASSWORD',
	...
	{
		return array(
			'SALESFORCE_LIVE_MODE' => Configuration::get('SALESFORCE_LIVE_MODE', true),
			'SALESFORCE_ACCOUNT_EMAIL' => Configuration::get('SALESFORCE_ACCOUNT_EMAIL', 'contact@prestashop.com'),
			'SALESFORCE_ACCOUNT_PASSWORD' => Configuration::get('SALESFORCE_ACCOUNT_PASSWORD', null),
		);
	}
